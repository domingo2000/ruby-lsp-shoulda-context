    ...
    class ShouldaContextTest < Minitest::Test
      ...
      def test_multiple_contexts
        ...
        response[3..5].each do |response_|
          ...
          assert_equal({ start_line: 0, start_column: 0, end_line: 12, end_column: 3 }, response_.command.arguments[3])
        end
        ...
        response[15..17].each do |response_|
          ...
          assert_equal({ start_line: 8, start_column: 4, end_line: 10, end_column: 7 }, response_.command.arguments[3])
        end
      end
    end
  end
